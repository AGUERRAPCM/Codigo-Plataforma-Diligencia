...
@Component({
  selector: 'edit-user',
  templateUrl: './editarUsuarioSuper.component.html',
  styleUrls: ['./editarUsuarioSuper.component.css']
})
export class EditarUsuarioSuperComponent implements OnInit {
    ...
    actualizarUsuario(){
      ...
      this.usuarioService.updateSuper(this.usuario).subscribe(res =>{
      ...
      this.usuarioService.getUsuarioPorId(this.usuarioEditado).subscribe(res =>{
        if(res.IsSuccess = true){
            ...
            for( let usuarioObtenido of this.listaUsuarios){
              ...
              this.usuario.id_entidad=  usuarioObtenido.idEntidad;
